...
public static partial class GStoreClientService
{
  ...
  /// <summary>Client for GStoreClientService</summary>
  public partial class GStoreClientServiceClient : grpc::ClientBase<GStoreClientServiceClient>
  {
    /// <summary>Creates a new client for GStoreClientService</summary>
    /// <param name="channel">The channel to use to make remote calls.</param>
    public GStoreClientServiceClient(grpc::ChannelBase channel) : base(channel)
    {
    }
    /// <summary>Creates a new client for GStoreClientService that uses a custom <c>CallInvoker</c>.</summary>
    /// <param name="callInvoker">The callInvoker to use to make remote calls.</param>
    public GStoreClientServiceClient(grpc::CallInvoker callInvoker) : base(callInvoker)
    {
    }
    /// <summary>Protected parameterless constructor to allow creation of test doubles.</summary>
    protected GStoreClientServiceClient() : base()
    {
    }
    /// <summary>Protected constructor to allow creation of configured clients.</summary>
    /// <param name="configuration">The client configuration.</param>
    protected GStoreClientServiceClient(ClientBaseConfiguration configuration) : base(configuration)
    {
    }
    ...
    protected override GStoreClientServiceClient NewInstance(ClientBaseConfiguration configuration)
    {
      return new GStoreClientServiceClient(configuration);
    }
  }
